...
public synchronized void onResume()
	...
	if(!mEnablingBT)
		{ // If we are turning on the BT we cannot check if it's enable
...
protected int[]				mForePaint		= { 0xff000000, // Black
											...
											0xffff00ff, // magenta
											0xff00ffff, // cyan
											0xffffffff // white -- is overridden
														// by constructor
											};
protected int[]				mBackPaint		= { 0xff000000, // Black -- is
															// overridden by
															// constructor
											0xffcc0000, // Red
											0xff00cc00, // green
...
public InputConnection onCreateInputConnection(EditorInfo outAttrs)
	...
	return new BaseInputConnection(this, false)
	{
		...
		private final String	KEYCODE_CHARS	= "\000\000\000\000\000\000\000" + "0123456789*#" + "\000\000\000\000\000\000\000\000\000\000" + "abcdefghijklmnopqrstuvwxyz,." + "\000\000\000\000" + "\011 " // tab,
																																																				// space
														+ "\000\000\000" // sym
																			// ..
																			// envelope
